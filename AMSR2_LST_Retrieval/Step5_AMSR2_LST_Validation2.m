...
%     yearStr = '2013';
    ...
    load(modisLstMaskFilePath, 'modisLstMaskYearArray');  % single, 无效值是Nan.
    ...
    load(amsr2LstCnYearMatPath, 'amsr2LstCnYearArray', 'validDateList');  % single, 无效值是0.
    ...
    if strcmp(yearStr, '2013')
        ...
        load(regressionPureMatPath, 'amsr2LstCnYearArray3', 'amsr2LstMaskYearArray3');
